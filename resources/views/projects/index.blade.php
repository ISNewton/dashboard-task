    ...
    <div class="flex flex-wrap -mx-3">
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <a class="mr-12 rouned-2 bg-red-500 text-black text-right" href="{{ route('projects.create') }}">Add</a>
                                        ...
                                        <td
                                            ...
                                            <a href="{{ route('projects.edit' , $project->id) }}"
                                                ...
                                                <form action="{{ route('projects.destroy' ,$project->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button class="text-m font-semibold leading-tight text-slate-400">Delete</button>
                                                </form>
                                        </td>
                                    </tr>
                                @endforeach
